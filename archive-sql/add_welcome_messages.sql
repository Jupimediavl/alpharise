-- Add welcome_message column to milestones table
ALTER TABLE milestones ADD COLUMN welcome_message TEXT;

-- Update existing milestones with welcome messages
...
-- Success message
SELECT 'Welcome messages added successfully!' as message;